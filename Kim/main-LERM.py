...
#for SOURCE1, SOURCE2 in [ ('D6a','D6b'), ('D2a','D2b'), ('D3a','D3b')]:
    ...
    for repeat in range(RTESTS):
        ...
        summ_idx_1, summ_idx_2 = optm.summarize(source1, source2, stats_source_1, stats_source_2, METHOD, OPTM_MODE)
        ...
        if EVALUATION_MODE: 
            ...
            n['parameters']['optmization'] = OPTM_MODE
