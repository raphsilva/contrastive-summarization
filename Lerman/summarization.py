    ...
    for s in range(1, LIM_SENTENCES+1): 
        ...
        for best_prev in best_for_size_prev:
            ...
            for i in candidate_options_1:    
                ...
                if SPEED == 'CAREFUL': # Isso aqui é para mexer só um lado do sumário (mas não melhorou o método)
                    ...
                    stats_cand_1_0 = struct.aspects_stats(summ_cand_1_0)
                ...
                for j in candidate_options_2: 
                    ...
                    if SPEED == 'CAREFUL':
                        ...
                        stats_cand_2_0 = struct.aspects_stats(summ_cand_2_0)
                    # If there's not enough data to calculate stdev
                    ...
                    score = method.SAM_contrastive(stats_source_1, stats_source_2, stats_cand_1, stats_cand_2)#*((len(idx_cand_1)+len(idx_cand_2))**0.1)
                    
                    if SPEED == 'CAREFUL':
                        score_01 = method.SAM_contrastive(stats_source_1, stats_source_2, stats_cand_1_0, stats_cand_2)#*((len(idx_cand_1)+len(idx_cand_2))**0.1)
                        score_10 = method.SAM_contrastive(stats_source_1, stats_source_2, stats_cand_1, stats_cand_2_0)#*((len(idx_cand_1)+len(idx_cand_2))**0.1)
